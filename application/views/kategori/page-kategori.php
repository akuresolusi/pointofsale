			...
			<div class="panel panel-default panel-title">
				<div class="panel-body title-pos">
					<div class="col-md-6" style="padding: 0;">
						<span id="sub-title">Kategori</span>
					...
					<div class="col-md-6 add-data">
					    ...
					    <span class="fa fa-plus"> Tambah Kategori</span></button></a>
					</div>
				</div>
			</div>
				...
				<div class="panel-heading">
				  ...
				  <div class="panel-body">
						<table id="data" class="table table-striped table-hover">
							<thead>
								<th width="20">No</th>
								<th width="700">Kategori Barang</th>
								<th width="10">Aksi</th>
							</thead>
							<tbody>
							<?php
										...
										<td style='text-align: center;'>
											<div class='dropdown'>
												...
												><span class='fa fa-edit'></span> Edit Data</a></li>
										            <li><a href='".base_url()."kategori/hapus_kategori?id=".$value['id']."'><span class='fa fa-trash'></span> Hapus Data</a></li>
										        </ul>
									    	</div>
										</td>
									</tr>";
