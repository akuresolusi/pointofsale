			...
			<div class="panel panel-default panel-title">
				<div class="panel-body title-pos">
					...
					<div class="col-md-6 add-data">
					    <a href="<?php echo base_url(); ?>pegawai/tambah"><button class="btn btn-primary btn-action btn-add" data-toggle="modal" data-target="#myModal"><span class="fa fa-plus"> Tambah Pegawai</span></button></a>
					</div>
				</div>
			</div>
