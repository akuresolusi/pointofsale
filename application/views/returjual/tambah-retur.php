	...
	<div class="container-fluid">
				...
				<div class="panel-body title-pos body-blue">
					...
					<div class="form-group col-md-3">
					    	<label>No. Faktur Penjualan</label>
					      	<input type="text" class="form-control" value="<?php echo $this->input->get('faktur') ?>"  id="faktur" placeholder="No. Faktur Penjualan">
					</div>	
					<div class="form-group col-md-4">
					    	<label>Nama Pelanggan</label>
					      	<input type="text" class="form-control" value="<?php echo @$pelanggan['nama'] ?>" placeholder="Pelanggan" disabled="">
					</div>	
					<!-- <div class="col-md-5">
		...
		<div class="panel panel-default">
		    	<div class="panel-body">
					<?php echo form_open(base_url('returjual/selesai?faktur='.$faktur['faktur'])); ?>
					  	<div class="form-group">
					    <div class=" form-group col-md-8">
					  		<label>Alamat</label>
					  		<textarea class="form-control" placeholder="Alamat" style="height: 105px" disabled=""><?php echo $pelanggan['alamat'] ?></textarea>
					  	</div>
					  	...
					  	<div class="col-md-12">
						    ...
						    <?php
						    	...
						    	foreach ($list_items as $value) {
						    		...
						    		$retur_items = $this->returjual_model->retur_penjualan_item($faktur['faktur'], $value['idbarang'])['jumlah'];
					    	...
					    	<a href="<?php echo base_url(); ?>returjual" class="btn btn-warning" style="margin-bottom: 10px;""><span class="fa fa-list"></span> Daftar Retur Penjualan</a>
...
$(document).ready(function(){
	...
	$('#faktur').keyup(function(e){
	    if(e.keyCode == 13){
	    	window.location.href = "<?php echo base_url('returjual/tambah?faktur='); ?>" + $(this).val();
	    }
	});
