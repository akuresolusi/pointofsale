						...
						<div class="panel panel-default panel-title">
							<div class="panel-body title-pos body-blue">
								...
								<div class="form-group col-md-3">
								    	<label>No. Faktur Penjulan</label>
								      	<input type="text" class="form-control" placeholder="No. Faktur Penjualan">
								</div>	
								...
								<form>
								    ...
								    <div class="col-md-3">
								  	...
								  	<div class="col-md-12">
								    	...
								    	<a href="<?php echo base_url(); ?>returjual" class="btn btn-warning" style="margin-bottom: 10px;""><span class="fa fa-list"></span> Daftar Retur</a>
