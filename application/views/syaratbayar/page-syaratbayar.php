			...
			<div class="panel panel-default panel-title">
				<div class="panel-body title-pos">
					<div class="col-md-6" style="padding: 0;">
						<span id="sub-title">Syarat Bayar</span>
						<h3 class="page-title"><?php echo $title; ?></h3>
					</div>
					<div class="col-md-6 add-data">
					    <a href="#"><button class="btn btn-primary btn-action btn-add" data-toggle="modal" data-target="#myModal"><span class="fa fa-plus"> Tambah Syarat Bayar</span></button></a>
					</div>
				</div>
			</div>
			<div class="panel panel-headline">
				...
				<div class="panel-body">
					<table id="data" class="table table-striped table-hover">
						<thead>
							<th width="20">No</th>
							<th width="650">Nama Syarat Bayar</th>
							<th>Tempo</th>
							<th width="30">Aksi</th>
						</thead>
						<tbody>
